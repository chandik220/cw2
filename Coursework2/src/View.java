...
public class View {
    ...
    View(){
        ...
        ArrayList<Boooks> book= new ArrayList<Boooks>();
        ...
        try {
            ...
            while(result.next()) {
                ...
                Boooks stff =new Boooks(BookName, AuthorName, date, price,bookNumber, Quantity);
                book.add(stff);
...
////            System.out.println("..............");
      ...
      btnUpdate.addActionListener(e->{
          ...
          if(row>=0) {
              ...
              btnChange.addActionListener(e3->{
                  ...
                  String uquery ="update `books` set `b_name` = '" + tbName + "',`a_name` = '" + taName + "', `price` = '" + price + "',  `p_date` = '"+ tpDate +"' WHERE `bcode` = '"+ Code +"'";
                  String squery ="update `soldb` set `b_name` = '" + tbName + "',`a_name` = '" + taName + "', `price` = '" + price + "',  `p_date` = '"+ tpDate +"' WHERE `b_name` = '"+ BookName1 +"'";
      ...
      btnSearch.addActionListener(e3->{
          ...
          String query2="select * from books where a_name='" + Search + "' or b_name='" + Search + "' or p_date='" + Search + "'";
          try {
              ...
              TableModel model=jt.getModel();
               ...
               try {
                  ...
                  if(result3.next()) {
                      ...
                      String urquery = "update `soldb` set `quantity` = '" + prevQuan++ + "' WHERE `b_name` = '"+ BookName +"'";
                      int uresult = db.connection().executeUpdate(uquery);
                      ...
                      String dquery = "update `books` set `quantity` = '" + Quantity + "' WHERE `bcode` = '"+ code +"'";
                       String aquery = "insert into soldb(b_name,a_name,p_date,price,quantity) values('"+BookName+"','"+AuthorName+"','"+date+"','"+price+"','"+Quan+"') ";
                       try {
                          int dresult = db.connection().executeUpdate(dquery);
